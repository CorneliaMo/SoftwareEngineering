...
public class AuthController {
    ...
    public UserAuthResponse register(@RequestBody RegisterRequest request) {
        return null;
    }
     ...
     */
    @PostMapping("/login")
    public UserAuthResponse login(@RequestBody LoginRequest request) {
        return null;
    }
    ...
    public AdminAuthResponse adminLogin(@RequestBody AdminLoginRequest request) {
        return null;
    }
}
